...
# Using TMLE with and without Adaptive Pre-specification 
...
#       * for specification of candidates, see aps/get.cand.adj 
#
...
#     Details in Benitez et al. Stat Med 2023
...
Stage2 <- function(goal='aRR', target='clust', data.input, do.unadjusted=F, 
  ...
  if( do.unadjusted){
    # print('running unadj')
    # THIS DOES NOT INCORPORATE WEIGHTS  - WARNING 
...
#   target of inference: cluster-level ("clust") or pooled-indv effect ("indv") (target) 
#		dataset (Vdata)
#   sample.effect: indicator if targeting the sample vs. population effect
